...
$pages = mysqli_query($connect,"SELECT count(id) AS id FROM kapitan");
...
$query = "SELECT * FROM kapitan LIMIT $start, $limit";
	...
	while ($row = mysqli_fetch_array($res)) {
		 ...
		 $output .= "
             <div class='col-md-4 shadow-sm rounded bg-white d-flex justify-content-center'>
				<form method='post'>
					<img src='KapitanMenu/".$row['image']."' class='col-md-12' height='300px'>
